...
- SOURCE_CHANNELS - я дійшов до того, що по Києву (і автоматично області) достатньо двох - офіційного [@kpszsu](https://t.me/kpszsu)(-1001223955273) і найпершого [@war_monitor](https://t.me/war_monitor)(-1001641260594). Решта або повільніші і просто дублюють, або менш точні, або непридатні для парсингу, або часом пропускають (жахаюча більшість таких каналів - помийки). Юзернейми були замінені на ід для зниження к-сті помилок. Дізнатись ід каналу можна в веб-версії.
...
Раз в пару місяців необхідно оновлювати telethon, як і будь-який інший клієнт Telegram, інакше сповіщення будуть з затримкою.
